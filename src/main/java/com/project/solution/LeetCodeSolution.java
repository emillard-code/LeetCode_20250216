...
public class LeetCodeSolution {
    ...
    private static boolean findLexicographicallyLargestSequence(int currentIndex, int[] resultSequence,
            boolean[] isNumberUsed, int targetNumber) {
        ...
        if (resultSequence[currentIndex] != 0) {
            ...
            return findLexicographicallyLargestSequence(currentIndex + 1, resultSequence,
                    isNumberUsed, targetNumber);
        ...
        for (int numberToPlace = targetNumber; numberToPlace >= 1; numberToPlace--) {
            ...
            if (numberToPlace == 1) {
                ...
                if (findLexicographicallyLargestSequence(currentIndex + 1, resultSequence,
                        isNumberUsed, targetNumber)) { return true; }
